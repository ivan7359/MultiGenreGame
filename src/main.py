...
# Main menu
        ...
        self.mainMenuWidgets['left_arrow_button'] = pygame_gui.elements.UIButton(relative_rect=pygame.Rect(((WIDTH * 0.66) - (arrow_btn_width) - OFFSET, (HEIGHT * 0.66) + (OFFSET * 2)), (arrow_btn_width, arrow_btn_height)), text='Left arrow', manager=self.manager)       # left_arrow_button
        self.mainMenuWidgets['right_arrow_button'] = pygame_gui.elements.UIButton(relative_rect=pygame.Rect(((WIDTH * 0.66) + OFFSET, (HEIGHT * 0.66) + (OFFSET * 2)), (arrow_btn_width, arrow_btn_height)), text='Right arrow', manager=self.manager)     # right_arrow_button
...
# Settings        
        ...
        self.settingsWidgets['Back_button'] = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((OFFSET * 3, (HEIGHT - btn_Back_ok_height) - (OFFSET * 3)), (btn_Back_ok_width, btn_Back_ok_height)), text='Back', manager=self.manager)
        self.settingsWidgets['OK_button'] = pygame_gui.elements.UIButton(relative_rect=pygame.Rect(((WIDTH - btn_Back_ok_width) - (OFFSET * 3), (HEIGHT - btn_Back_ok_height) - (OFFSET * 3)), (btn_Back_ok_width, btn_Back_ok_height)), text='OK', manager=self.manager)
        ...
        self.settingsWidgets['Screen_DDM'] = pygame_gui.elements.UIDropDownMenu(options_list=["Fullsreen", "2", "3"], starting_option="Fullscreen", relative_rect=pygame.Rect(((WIDTH / 3) - (OFFSET * 5.27), (HEIGHT * 0.66) + (OFFSET * 6.2)), (menu_width, menu_height)), manager=self.manager)
        ...
        self.settingsWidgets['Left_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 4.8))), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        ...
        self.settingsWidgets['Right_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 5.6) + textEntryLine_height)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        ...
        self.settingsWidgets['Jump_platformer_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 6.4) + textEntryLine_height * 2)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        self.settingsWidgets['Jump_shooter_label'] = pygame_gui.elements.UILabel(relative_rect=pygame.Rect(((WIDTH * 0.66) - label_settings_width + (OFFSET * 0.92), (HEIGHT / 3) + (OFFSET * 8) + (label_settings_height * 3)), (label_settings_width, label_settings_height)), text="Jump (shooter)", manager=self.manager)
        self.settingsWidgets['Jump_shooter_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 7.2) + textEntryLine_height * 3)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        self.settingsWidgets['Sit_down_label'] = pygame_gui.elements.UILabel(relative_rect=pygame.Rect(((WIDTH * 0.66) - label_settings_width + (OFFSET * 0.92), (HEIGHT / 3) + (OFFSET * 9) + (label_settings_height * 4)), (label_settings_width, label_settings_height)), text="Sit down (platformer)", manager=self.manager)
        self.settingsWidgets['Sit_down_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 8) + textEntryLine_height * 4)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        self.settingsWidgets['Melee_platformer_label'] = pygame_gui.elements.UILabel(relative_rect=pygame.Rect(((WIDTH * 0.66) - label_settings_width + (OFFSET * 0.92), (HEIGHT / 3) + (OFFSET * 10) + (label_settings_height * 5)), (label_settings_width, label_settings_height)), text="Sit down (shooter)", manager=self.manager)
        self.settingsWidgets['Melee_platformer_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 8.8) + textEntryLine_height * 5)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        self.settingsWidgets['Weapon_change_label'] = pygame_gui.elements.UILabel(relative_rect=pygame.Rect(((WIDTH * 0.66) - label_settings_width + (OFFSET * 0.92), (HEIGHT / 3) + (OFFSET * 11) + (label_settings_height * 6)), (label_settings_width, label_settings_height)), text="Weapon change (platformer)", manager=self.manager)
        self.settingsWidgets['Weapon_change_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 9.6) + textEntryLine_height * 6)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
        ...
        self.settingsWidgets['Fire_text_line'] = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((((WIDTH * 0.66) + (OFFSET * 7), (HEIGHT / 3) + (OFFSET * 10.4) + textEntryLine_height * 7)), (textEntryLine_width, textEntryLine_height)), manager=self.manager)
